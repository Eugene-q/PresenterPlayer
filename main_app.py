...
#             self.load(self.list.song(self.list.playing))
    ...
    def start_volume_update(self):
        ...
        playback_pos = self.position() #дублировано для проверки повтора
    ...
    def update_volume_automation(self, song, playback_pos):
